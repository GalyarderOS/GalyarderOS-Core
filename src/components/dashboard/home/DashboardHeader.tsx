...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return <div className="relative overflow-hidden border-b bg-gradient-to-b from-muted/20 to-background">
        ...
        duration: 0.8
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="relative">
              {loadingProfile ? <Skeleton className="w-20 h-20 rounded-full" /> : <Avatar className="w-24 h-24 text-3xl">
          ...
          duration: 0.6
            ...
            {loadingProfile ? <div className="flex flex-col items-center gap-2">
                <Skeleton className="h-12 w-3/4" />
              </div> : <h1 className="text-4xl font-bold text-foreground mb-4 leading-tight md:text-base">

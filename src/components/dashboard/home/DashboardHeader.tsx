...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ stats }) => {
  ...
  const dotColor = theme === 'dark' ? '#4B5563' : '#D1D5DB'; // gray-600 and gray-300
  const encodedDotColor = encodeURIComponent(dotColor);
  const dotPattern = `data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='${encodedDotColor}' fill-opacity='0.3'%3E%3Cpath d='M0 38.59l2.83-2.83 1.41 1.41L1.41 40H0v-1.41zM0 1.4l2.83 2.83 1.41-1.41L1.41 0H0v1.41zM38.59 40l-2.83-2.83 1.41-1.41L40 38.59V40h-1.41zM40 1.41l-2.83 2.83-1.41-1.41L38.59 0H40v1.41zM20 18.6l2.83-2.83 1.41 1.41L21.41 20l2.83 2.83-1.41 1.41L20 21.41l-2.83 2.83-1.41-1.41L18.59 20l-2.83-2.83 1.41-1.41L20 18.59z'/%3E%3C/g%3E%3C/svg%3E`;

  return (
    <div className="relative overflow-hidden">
      {/* Theme-aware background */}
      <div className="absolute inset-0 bg-gradient-to-b from-muted/20 via-background/50 to-background" />
      <div
